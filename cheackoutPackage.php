                                                                              ...
                                                                              <div class="col-8 h-100  p-2 ">
                                                                                    ...
                                                                                    <table class="w-100 h-100">
                                                                                          ...
                                                                                          <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                      <input type="number" value="1" min="1" max="1" onchange="qtyChangeCart(<?php echo $d1['pid'] ?>);" id="qty<?php echo $d1['pid'] ?>" class="qtyinput ps-2 border-0" disabled />
                                                                                          ...
                                                                                          <tr>
                                                                                                ...
                                                                                                <td>Rs: <?php echo $d1["price"] ?>.00 x <span id="qtyview<?php echo $d1['pid'] ?>"> 1</span></td>
                                                                                          </tr>
                                                                                          <tr>
                                                                                                <td>Delivery</td>
                                                                  ...
                                                                  <table class="delinfo w-100">
                                                                        ...
                                                                        <tr>
                                                                              <td>
                                                                                    ...
                                                                                    <select class="w-100" id="cityID" onchange="dFeechangePackage(<?php echo $packid  ?>)">
                                                                  ...
                                                                  <table class="priceicng w-100 mb-3">
                                                                        ...
                                                                        <tr class="proprice">
                                                                              ...
                                                                              <td>Rs: <?php
                                                                                          ...
                                                                                          $dis=0;
                                                                                          if ($d["discount"] != 0) {
                                                                                                $dis = ceil($subtotal * ($d["discount"] / 100));
                                                                                          ?>
                                                                        ...
                                                                        <tr class="total">
                                                                              <td>Total</td>
                                                                              <td>Rs: <?php echo number_format($subtotal  + $quriarCharge - $dis, 2) ?></td>
